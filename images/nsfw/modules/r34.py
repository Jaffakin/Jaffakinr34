...
class r34():
	...
	def __init__(self, bot, core):
		...
		self.base_url = "https://rule34.xxx/index.php?page=dapi&s=post&q=index&limit=100"
	...
	async def get_page(self, url):
		...
		req = Request(url, headers={'User-Agent': 'Discord R34 Scraper'})
	...
	async def get_image_cache(self, soup):
		...
		for img in targets:
			...
			src = img["file_url"]
			src = "https://rule34.xxx/" + src[23:]

			sauce = img["id"]
			sauce = "https://rule34.xxx/index.php?page=post&s=view&id=" + str(sauce)
